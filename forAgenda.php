...
<body>
  <div class="bg">
    ...
    <div class="layout">
      <?php $active = 'agenda'; require __DIR__ . '/partials/sidebar.php'; ?>
              ...
              <div class="table__row">
                ...
                <div class="table__td table__td--action">
                  <div class="rowactions">
                    <form method="post" action="forAgenda.php">
